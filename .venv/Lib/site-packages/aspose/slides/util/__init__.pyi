...
class SlideUtil:
    ...
    @staticmethod
    def to_save_format(format: SourceFormat) -> aspose.slides.export.SaveFormat:
        '''Converts a source file format to the corresponding :py:enum:`aspose.slides.export.SaveFormat`.
        :param format: The source file format.
        :returns: The corresponding :py:enum:`aspose.slides.export.SaveFormat` value.'''
        ...
