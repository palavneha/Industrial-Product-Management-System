...
class IPptxOptions:
    ...
    def compression_level(self, value: CompressionLevel):
        ...
...
class CompressionLevel:
    '''Specifies ZIP compression levels for OpenXML file.
                Higher levels provide better compression at the cost of slower processing.'''
    @classmethod
    @property
    def NONE(cls) -> CompressionLevel:
        '''No compression is applied. Files are stored as-is.'''
        ...

    @classmethod
    @property
    def LEVEL1(cls) -> CompressionLevel:
        '''Fastest compression with the lowest compression ratio.'''
        ...

    @classmethod
    @property
    def LEVEL2(cls) -> CompressionLevel:
        '''Faster compression with slightly better compression ratio than :py:attr:`aspose.slides.export.CompressionLevel.LEVEL1`.'''
        ...

    @classmethod
    @property
    def LEVEL3(cls) -> CompressionLevel:
        '''Provides better compression than :py:attr:`aspose.slides.export.CompressionLevel.LEVEL2` with moderate performance impact.'''
        ...

    @classmethod
    @property
    def LEVEL4(cls) -> CompressionLevel:
        '''Provides better compression than :py:attr:`aspose.slides.export.CompressionLevel.LEVEL3`.'''
        ...

    @classmethod
    @property
    def LEVEL5(cls) -> CompressionLevel:
        '''Provides improved compression over :py:attr:`aspose.slides.export.CompressionLevel.LEVEL4` with additional processing time.'''
        ...

    @classmethod
    @property
    def LEVEL6(cls) -> CompressionLevel:
    ...
    @classmethod
    @property
    def LEVEL7(cls) -> CompressionLevel:
        '''Provides higher compression than :py:attr:`aspose.slides.export.CompressionLevel.LEVEL6` with slower processing.'''
        ...

    @classmethod
    @property
    def LEVEL8(cls) -> CompressionLevel:
        '''Provides higher compression than :py:attr:`aspose.slides.export.CompressionLevel.LEVEL7`.'''
        ...

    @classmethod
    @property
    def LEVEL9(cls) -> CompressionLevel:
