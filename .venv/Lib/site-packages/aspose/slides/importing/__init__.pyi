...
class ExcelWorkbookImporter:
    ...
    @overload
    @staticmethod
    def add_table_from_workbook(shapes: IShapeCollection, x: float, y: float, workbook: aspose.slides.excel.IExcelDataWorkbook, worksheet_name: str, cell_range: str) -> ITable:
        ...
        :param cell_range: The cell range that defines the table (for example, "A1:D10").
        :returns: The table that was added to the shape collection.'''
        ...

    @overload
    @staticmethod
    def add_table_from_workbook(shapes: IShapeCollection, x: float, y: float, workbook_path: str, worksheet_name: str, cell_range: str) -> ITable:
        ...
        :param x: The X coordinate for positioning the table.
        :param y: The Y coordinate for positioning the table.
        :param workbook_path: The path to the Excel workbook file.
        :param worksheet_name: The name of the worksheet that contains the table.
        :param cell_range: The cell range that defines the table (for example, "A1:D10").
        :returns: The table that was added to the shape collection.'''
        ...
    ...
    @overload
    @staticmethod
    def add_table_from_workbook(shapes: IShapeCollection, x: float, y: float, workbook_stream: io.RawIOBase, worksheet_name: str, cell_range: str) -> ITable:
        '''Retrieves a table from the specified Excel workbook file and adds it to the end of the given shape collection at the specified coordinates.
        :param shapes: The shape collection to which the table will be added.
        :param x: The X coordinate for positioning the table.
        :param y: The Y coordinate for positioning the table.
